...
class DataArguments:
    ...
    dataset_file_list: Optional[List[str]] = field(  # New field
        default=None,
        metadata={"help": "List of specific dataset files to load (e.g., Parquet files)."},
    )
...
class GenerationArguments:
    ...
    save_directory: str = field(
        default=None,
        metadata={"help": "Local directory to save the generated data."}
    )
...
class RewardArguments:
    ...
    save_directory: str = field(
        default=None,
        metadata={"help": "Local directory to save the reward model labeled data."}
    )
